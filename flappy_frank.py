...
frank_imgs = [pygame.transform.scale((pygame.image.load(os.path.join('imgs', 'frank1.png'))), (100, 100)),
              pygame.transform.scale(
                  (pygame.image.load(os.path.join('imgs', 'frank2.png'))), (100, 100)),
              pygame.transform.scale((pygame.image.load(os.path.join('imgs', 'frank3.png'))), (100, 100))]
back_img = pygame.transform.scale(
    (pygame.image.load(os.path.join('imgs', 'background.png'))), (600, 800))
can_img = pygame.transform.scale(
    (pygame.image.load(os.path.join('imgs', 'can.png'))), (150, 600))
base_img = pygame.transform.scale(
    (pygame.image.load(os.path.join('imgs', 'base.png'))), (600, 100))
frank_start_img = pygame.transform.scale(
    (pygame.image.load(os.path.join('imgs', 'frank1.png'))), (250, 250))
play_img = pygame.transform.scale(
    (pygame.image.load(os.path.join('imgs', 'play.png'))), (150, 100))
play_img2 = pygame.transform.scale(
    (pygame.image.load(os.path.join('imgs', 'play2.png'))), (150, 100))
medal_img = pygame.transform.scale(
    (pygame.image.load(os.path.join('imgs', 'egg.png'))), (130, 100))
